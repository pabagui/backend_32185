...
// DESAFÍO 17: desplegar en la nube con AWS

import { productosRouterAws } from '../../aws/productosRouterAws.js'; 

app.use('api/awsproducts', productosRouterAws) 

app.listen(PORT, err => {
    if (!err)  logger.info(`🔥Servidor express escuchando el puerto ${PORT} - PID WORKER ${process.pid}🔥`) //desafio 16 logger
    // console.log(`🔥Servidor express escuchando el puerto ${PORT} - PID WORKER ${process.pid}🔥`)
})