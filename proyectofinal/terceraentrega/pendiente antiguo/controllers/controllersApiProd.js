...
import { ContenedorArchivo } from'../containers/contenedorProductos.js';

// const products = [];
const products = new ContenedorArchivo('productos.txt');

export function controllerPostProducts(newProduct){
...
export function controllerGetProducts(){
...
export function controllerGetProductsById(id){
...
export function controllerPutProductsById(id){
        const searchedIndex = products.update(id);
        return searchedIndex
    }

export function controllerDeleteProductsById(id){
